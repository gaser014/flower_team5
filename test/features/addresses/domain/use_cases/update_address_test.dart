...
void main() {
  ...
  test('should update address via repository', () async {
    when(
      mockRepository.updateAddress(address: anyNamed('address')),
    ...
    verify(mockRepository.updateAddress(address: tEntity)).called(1);
  });
