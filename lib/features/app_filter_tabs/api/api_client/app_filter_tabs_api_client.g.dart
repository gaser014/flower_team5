...
part of 'app_filter_tabs_api_client.dart';
...
class _AppFilterTabsApiClient implements AppFilterTabsApiClient {
  _AppFilterTabsApiClient(this._dio, {this.baseUrl, this.errorLogger}) {
